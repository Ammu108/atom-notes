...
const PyqTable = () => {
	...
	const deleteNoteMutation = useDeletePyqs();
	const { data: pyqs, isPending } = useGetAllPyqs();
	const [deleteDialogOpen, setDeleteDialogOpen] = useState(false);
	const [selectedNote, setSelectedNote] = useState<{
		id: string;
	} | null>(null);

	const handleNavigateToNotes = (pyqId: string) => {
		router.push(`/pyqs/${pyqId}`);
	};
