...
import { usePyqAllPurchases } from "../api";
...
export function PyqPurchasesTable() {
	const { data: purchases, isLoading } = usePyqAllPurchases();
						...
						{isLoading ? (
							...
							purchases.map((purchase) => (
								<TableRow key={purchase.id}>
									...
									<TableCell>{purchase.pyqTitle}</TableCell>
									...
									<TableCell className="text-right">
										<Link href={`/pyq-purchases/${purchase.id}`}>
